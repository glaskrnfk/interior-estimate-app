...
function openReceiptWindow() {
    ...
    var bodyHtml = ''
        ...
        + '  <label>부가세<small style="opacity:.7;font-size:10px">(자동·수정가능)</small><input type="number" id="rv" placeholder="자동계산" title="공급가액 입력 시 10% 자동계산. 직접 수정 가능."></label>'
...
function buildPopupJs() {
    return '(function() {\n'
        ...
        + '    var v = parseInt(gv("rv")) || Math.round(s * 0.1);\n'
        + '    var t = s + v;\n'
        ...
        + '    document.getElementById("rv").value = v || "";\n'
        + '    document.getElementById("rt").value = (s + v) || "";\n'
        + '  });\n'
        ...
        + '    this.title = "수동 수정됨 — 공급가액 변경 시 자동 재계산";\n'
        + '  });\n'
