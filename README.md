...
### ✅ 2026-05-07 최신 세션 완료 작업

| ID | 기능 | 파일 |
|----|------|------|
| #14-A | **인테리어 표준계약서 전면 재작성** — 공정위 표준약관 준용 11개 조항, 계약 당사자 테이블, 공사 개요 테이블, 대금지급 스케줄 테이블 포함 | admin.html |
